...
*/
  ...
  \**********************/
    ...
    /* harmony import */ var _ToDoFactory_js__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(/*! ./ToDoFactory.js */ "./src/ToDoFactory.js");

    let projectOne = new _ToDoFactory_js__WEBPACK_IMPORTED_MODULE_1__.project(
      "Testproject"
    );
    let ToDoZwei = new _ToDoFactory_js__WEBPACK_IMPORTED_MODULE_1__.toDo(
      "bla",
      "blub",
      12,
      "important"
    ...
    ToDoZwei.addToList();
    console.log(_ToDoFactory_js__WEBPACK_IMPORTED_MODULE_1__.toDoArray);
    console.log(projectOne);
    console.log(_ToDoFactory_js__WEBPACK_IMPORTED_MODULE_1__.projectArray);
